...
visNetwork(nodes = new_net$nodes,
    ...
    visLegend(addNodes = lnodes, useGroups = FALSE, ncol = 3)
```
...
As defined in the documentation, Burt's Constraint index is higher if ego has less, or mutually stronger related (i.e. more redundant) contacts. This means that
